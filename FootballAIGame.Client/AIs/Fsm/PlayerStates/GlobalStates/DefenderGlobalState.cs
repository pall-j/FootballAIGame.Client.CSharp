...
{
    /// <summary>
    /// Represents the defender's global state. Keeps <see cref="FieldPlayerGlobalState"/> internally and calls
    /// its methods at the end of its own methods.
    /// </summary>
    class DefenderGlobalState : PlayerState
    {
        /// <summary>
        /// Gets or sets the field player' global state that is used at the end of the this state methods.
        /// </summary>
        /// <value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DefenderGlobalState"/> class.
        /// </summary>
